...
const PublicBookingStatusPage = lazy(
  () => import("@/features/booking/PublicBookingStatusPage"),
);
const BookingRequestsPage = lazy(
  () => import("@/features/booking/BookingRequestsPage"),
);
const DashboardPage = lazy(() => import("@/features/DashboardPage"));

const PatientListPage = lazy(
  () => import("@/features/patients/PatientListPage"),
);
...
const PatientForm = lazy(() =>
  import("@/features/patients/PatientForm").then((m) => ({
    default: m.PatientForm,
  })),
);
...
const AppointmentsListPage = lazy(
  () => import("@/features/appointments/AppointmentsListPage"),
);

const TodayPage = lazy(() => import("@/features/medical-records/TodayPage"));
const MyQueuePage = lazy(
  () => import("@/features/medical-records/MyQueuePage"),
);
const MyPatientsPage = lazy(
  () => import("@/features/medical-records/MyPatientsPage"),
);
...
const InvoiceListPage = lazy(
  () => import("@/features/billing/InvoiceListPage"),
);
...
const ExpenseListPage = lazy(
  () => import("@/features/expense/ExpenseListPage"),
);

const PayrollDashboardPage = lazy(
  () => import("@/features/payroll/PayrollDashboardPage"),
);
const PeriodDetailPage = lazy(
  () => import("@/features/payroll/PeriodDetailPage"),
);
const PayrollConfigPage = lazy(
  () => import("@/features/payroll/PayrollConfigPage"),
);
const CompensationListPage = lazy(() =>
  import("@/features/payroll/CompensationListPage").then((m) => ({
    default: m.CompensationListPage,
  })),
);
const MyCompensationPage = lazy(
  () => import("@/features/payroll/MyCompensationPage"),
);
...
const ShiftApprovalInbox = lazy(
  () => import("@/features/shift/ShiftApprovalInbox"),
);
...
const BrandPreviewPage = lazy(
  () => import("@/features/brand/BrandPreviewPage"),
);
    ...
    >
      ...
      >
        ...
        <Route
          path="doctors"
          element={
            <ProtectedRoute permission="doctor.manage" roles={["clinic_admin"]}>
              <DoctorsPage />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path="schedule"
          element={
            <ProtectedRoute permission="schedule.read" roles={["clinic_admin"]}>
              <SchedulePage />
            </ProtectedRoute>
          }
        />
